...
impl EmailClient {
    pub fn new(base_url: String, sender_email: ParsedEmail, sender_name: ParsedName) -> Self {
...
mod tests {
    ...
    async fn send_email_fires_a_request_to_base_url() {
        ...
        let email_client = EmailClient::new(mock_server.uri(), sender_email, sender_name);
